...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val md5 = AstHash.md5(message = "123")
        val sha1 = AstHash.sha1(message = "123")
        val sha256 = AstHash.sha256(message = "123")
        val rsaKeys = AstRsa.generateKeyPair(this, RsaKeyType.RSA_KEY_8192)
...
/**
 *         val md5 = AstHash.md5(message = "123")
Log.d("Alpha", "md5 Result = $md5")

val sha1 = AstHash.sha1(message = "123")
Log.d("Alpha", "sha1 Result = $sha1")

val sha256 = AstHash.sha256(message = "123")
Log.d("Alpha", "sha256 Result = $sha256")
